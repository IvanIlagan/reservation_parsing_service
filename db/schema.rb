...
ActiveRecord::Schema[7.1].define(version: 2025_01_29_055935) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.decimal "payout_price", precision: 12, scale: 2, null: false
    t.decimal "security_price", precision: 12, scale: 2, null: false
